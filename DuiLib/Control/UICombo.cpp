...
void CComboUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
	...
	else if( _tcscmp(pstrName, _T("mousewheelenable")) == 0 ) SetMouseWheelEnable(_tcscmp(pstrValue, _T("true")) == 0);

    else CContainerUI::SetAttribute(pstrName, pstrValue);
}

/// 设置是否允许鼠标滚轮响应
void CComboUI::SetMouseWheelEnable( bool v_bMouseWheelEnable/* = true*/ )
{
	m_bMouseWheelEnable = v_bMouseWheelEnable;
}

bool CComboUI::IsMouseWheelEnable()
{
	return m_bMouseWheelEnable;
}
