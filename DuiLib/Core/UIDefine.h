...
#define  DUI_CTR_HORSLIDEPAGE					 (_T("HorSlidePage"))	// 水平滑动多页面
#define  DUI_CTR_VERSLIDEPAGE					 (_T("VerSlidePage"))	// 垂直滑动多页面
#define  DUI_CTR_SLIDEPAGEITEM					 (_T("SlidePageItem"))	// 滑动子页面
